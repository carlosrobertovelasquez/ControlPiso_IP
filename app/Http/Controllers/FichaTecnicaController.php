...
class FichaTecnicaController extends Controller
{
    ...
    public function bolillo(){
        ...
        IBERPLAS.ARTICULO AR
        WHERE 
        FI.ARTICULO=AR.ARTICULO AND LINEA='BOLILLOS'");

       

    	return view('ControlCalidad.Ficha_Tecnica.Bolillos.index', ['ficha' => $ficha]);
    }
    ...
    public function FichaTecnicaInsertado(Request $request,$id){
    ...
    public function FichaTecnicaBolillo(Request $request,$id){
